      ...
      <Card className={sn('card')}>
        <CardContent className={sn('content')}>
          <Box className={sn('content__task-title-container')}>
            ...
            <Typography className={sn('content__title-heading')}>
              Implement Snackbar Notifications with Redux
            </Typography>
          </Box>
          <Box>
            <Typography className={sn('content__title')}>
              Technologies Used
            </Typography>
            <Box className={sn('content__task-tags')}>
              ...
              <Chip
                label="TypeScript"
                className={sn('content__task-tags-used')}
              />
              <Chip
